...
const PublicationsScreen = (props: PublicationsScreenProps): React.ReactElement => {
  ...
  const publicationsNum = filteredPublications.length;
  ...
  return (
    <PageLayout>
      <SEO
        title="Publications"
        description="Selected talks, articles, and public mentions"
      />
      <Row>
      ...
      {publicationsNum === 0 && (
        <Row className="mt-6 text-gray-500">
          No publications added yet. Selected talks and articles will appear here.
        </Row>
      )}
    </PageLayout>
  );
